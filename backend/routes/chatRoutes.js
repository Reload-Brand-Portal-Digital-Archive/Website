...
router.post('/upload',  authMiddleware.verifyToken, chatController.uploadFile);
...
// Admin routes
router.post('/admin/upload',           authMiddleware.verifyToken, authMiddleware.isAdmin, chatController.uploadFile);
